 ...
 */
export type EventFilter = (event: InternalEvent) => boolean;
...
export interface Subscriber {
  ...
  send(event: InternalEvent, eventId: string): void;
...
export class EventRouter {
   ...
   */
  route(contextId: string, event: InternalEvent, eventId: string): number {
    const contextSubscribers = this.subscribers.get(contextId);
